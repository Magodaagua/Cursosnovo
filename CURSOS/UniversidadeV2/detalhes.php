...
<html lang="pt-br">
	...
	<?php
        ...
        // Verifica se o progresso é igual a 2 e salva na tabela inscrição
        if($progresso == 2){
            ...
            if($resultado_inscricao2) {
                // Atualiza o número de inscritos na tabela curso
                $query_update_curso = "UPDATE curso SET inscritos = inscritos + 1 WHERE ID_curso = '$ID_curso'";
                $resultado_update_curso = mysqli_query($conn, $query_update_curso);

                if($resultado_update_curso) {
                    //echo "Inscrição realizada com sucesso e número de inscritos atualizado!";
                } else {
                    //echo "Inscrição realizada, mas erro ao atualizar o número de inscritos.";
                }
            } else {
        ...
        if ($progresso == 100) {
            // Verificar se data_conclusao já está definida
            $query_check_data = "SELECT data_conclusao FROM inscricao WHERE id_usuario = ? AND id_curso = ?";
            $stmt_check_data = $conn->prepare($query_check_data);
            $stmt_check_data->bind_param("ii", $id_user, $ID_curso);
            $stmt_check_data->execute();
            $result = $stmt_check_data->get_result();
            $row = $result->fetch_assoc();

            if ($row['data_conclusao'] == NULL || $row['data_conclusao'] == '0000-00-00') {
               ...
               // echo "você já completou o curso na data: ".$row['data_conclusao'];
            }
        }
        ...
        WHERE i.id_usuario = '$id_user' AND c.ID_curso = '$ID_curso'";
    ...
    <body data-id-user="<?php echo $id_user; ?>">
        ...
        <div class="retangulograndecimadetalhes">
            ...
            <div class="retangulocimaladoedetalhes">
                ...
                <!-- Aulas favoritas -->
                <a class="anotacoesdetalhes" href="aulasfavoritas.php?ID_curso=<?php echo $ID_curso?>&Usuario=<?php echo $Usuario?>">
                ...
                <!-- Anexos -->
                <a class="anotacoesdetalhes" href="anexos.php?ID_curso=<?php echo $ID_curso?>&Usuario=<?php echo $Usuario?>">
                            ...
                            while ($row_aula = $result_aulas->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                if ($resultado_progresso) {
                                    ...
                                    if ($registro_progresso) {
                                        ...
                                        if ($registro_progresso['concluida']) {
                                            ...
                                            echo "<div class='aula'>
                                                    <div class='aula-inner'>
                                                        <p class='aula-titulo'>Aulas: $ordem | Título: $titulo | <a class='botaodetalhes' href='visualizar_aula.php?id_usuario=$id_user&id=$id_aul&modulo_id=$id_mdu&curso_id=$ID_curso&ordem=$ordem'>Concluído</a> | Status: <font color= green> Concluído </font>
                                                    </div>
                                                </div>";
                                        } else {
                                            ...
                                            echo "<div class='aula'>
                                                    <div class='aula-inner'>
                                                        <p class='aula-titulo'>Aulas: $ordem | Título: $titulo | <a class='botaodetalhes' href='visualizar_aula.php?id_usuario=$id_user&id=$id_aul&modulo_id=$id_mdu&curso_id=$ID_curso&ordem=$ordem'>Continuar</a> | Status: <font color=#4169e1> Em andamento </font> </p>
                                                    </div>
                                                </div>";
                                        }
                                    } else {
                                        ...
                                        echo "<div class='aula'>
                                                <div class='aula-inner'>
                                                    <p class='aula-titulo'>Aulas: $ordem | Título: $titulo | <a class='botaodetalhes' href='php/iniciar_aula.php?id_usuario=$id_user&id_aula=$id_aul&modulo_id=$id_mdu&curso_id=$ID_curso&ordem=$ordem'>Começar</a> | Status: <font color= red> Não iniciado </font> 
                                                </div>
                                            </div>";
                                    }
                                } else {
